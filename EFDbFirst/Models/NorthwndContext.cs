...
public partial class NorthwndContext : DbContext
{
    ...
    public virtual DbSet<StoraggeShipper> StoraggeShippers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=101-5\\SQLEXPRESS;Database=NORTHWND;Trusted_Connection=True;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("AddedDataControl");
        ...
        modelBuilder.Entity<StoraggeShipper>(entity =>
        {
            entity.HasKey(e => e.KargoId).HasName("PK__storagge__8E5A959B8AC65202");

            entity.ToTable("storagge_shippers");

            entity.Property(e => e.KargoId).HasColumnName("KargoID");
            entity.Property(e => e.KargoAdi).HasMaxLength(50);
            entity.Property(e => e.KargoTel)
                .HasMaxLength(11)
                .IsUnicode(false)
                .IsFixedLength();
        });
